...
<section class="content-header">
    <h1>
        Perhitungan NBC Tahun Ajaran 2017/2018
    </h1>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="container-fluid">
        ...
        <h6>Untuk mengetahui hasil variabel,kalikan semua hasil variabel pada Analisis Nilai tahun ajaran 2017 / 2018
            berikut:<h6>
                <li>Variabel A </li>
                <ul>
                ...
                <ul>
                    = {{number_format($a["a_hasil_bagi"][0],3 ) }} * {{number_format($a["a_hasil_bagi"][1],3 ) }} * {{number_format($a["a_hasil_bagi"][2],3 ) }} *
                    {{number_format($a["a_hasil_bagi"][3],3 ) }} * {{number_format($a["a_hasil_bagi"][4],3 ) }} * {{number_format($a["a_hasil_bagi"][5],3 ) }} *
                    {{number_format($a["a_hasil_bagi"][6],3 ) }}
                </ul>
                <ul>
                    = {{number_format($a["a_hasil_kali"],9 ) }}
                </ul>
                ...
                <ul>
                    = {{number_format($c["c_hasil_bagi"][0],3 ) }} * {{number_format($c["c_hasil_bagi"][1],3 ) }} * {{$c["c_hasil_bagi"][2]}} *
                ...
                <ul>
                    = {{number_format($d["d_hasil_bagi"][0],3 ) }} * {{number_format($d["d_hasil_bagi"][1],3 ) }} * {{$d["d_hasil_bagi"][2]}} *
                    {{number_format($d["d_hasil_bagi"][3],3 ) }} * {{number_format($d["d_hasil_bagi"][4],3 ) }} * {{number_format($d["d_hasil_bagi"][5],3 ) }} *
                ...
                <ul>
                    = {{$e["e_hasil_bagi"][0]}} * {{number_format($e["e_hasil_bagi"][1],3 ) }} * {{$e["e_hasil_bagi"][2]}} *
                    {{$e["e_hasil_bagi"][3]}} * {{$e["e_hasil_bagi"][4]}} * {{$e["e_hasil_bagi"][5]}} *
                    {{number_format($e["e_hasil_bagi"][6],3 ) }}
                </ul>
                <ul>
                    = {{number_format($e["e_hasil_kali"])}}
                </ul>
    </div>
</section>
            ...
            <div class="box-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="dataTable1" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            <tr>
                                <td>{{number_format($d["d_hasil_bagi"][0],3 ) }}</td>
                                <td>{{number_format($d["d_hasil_bagi"][1],3 ) }}</td>
                                <td>{{$d["d_hasil_bagi"][2]}}</td>
                                <td>{{number_format($d["d_hasil_bagi"][3],3 ) }}</td>
                                <td>{{number_format($d["d_hasil_bagi"][4],3 ) }}</td>
