...
<section class="content-header">
    <h1>
        Perhitungan NBC Tahun Ajaran 2015/2016
    </h1>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="container-fluid">
        ...
        <h6>Untuk mengetahui hasil variabel,kalikan semua hasil variabel pada Analisis Nilai tahun ajaran 2015 / 2016
            berikut:<h6>
                <li>Variabel A </li>
                <ul>
                ...
                <ul>
                    = {{number_format($c["c_hasil_kali"],7 ) }}
                </ul>
                ...
                <ul>
                    = {{number_format($d["d_hasil_bagi"][0],3 ) }} * {{number_format($d["d_hasil_bagi"][1],3 ) }} * {{number_format($d["d_hasil_bagi"][2],3 ) }} *
                ...
                <ul>
                    = {{$e["e_hasil_bagi"][0]}} * {{$e["e_hasil_bagi"][1]}} * {{number_format($e["e_hasil_bagi"][2],3 ) }} *
                    {{number_format($e["e_hasil_bagi"][3],3 ) }} * {{$e["e_hasil_bagi"][4]}} * {{$e["e_hasil_bagi"][5]}} *
                    {{$e["e_hasil_bagi"][6]}}
                </ul>
                <ul>
                    ...
                    <table class="table table-bordered table-striped" id="dataTable1" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{{number_format($e["e_hasil_bagi"][2],3 ) }}</td>
                                <td>{{number_format($e["e_hasil_bagi"][3],3 ) }}</td>
