...
<section class="content-header">
    <h1>
        Perhitungan NBC Tahun Ajaran 2018/2019
    </h1>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="container-fluid">
        ...
        <h6>Untuk mengetahui hasil variabel,kalikan semua hasil variabel pada Analisis Nilai tahun ajaran 2018 / 2019
            berikut:<h6>
                <li>Variabel A </li>
                <ul>
                ...
                <ul>
                    = {{number_format($c["c_hasil_kali"],5 ) }}
                </ul>
                ...
                <ul>
                    = {{number_format($d["d_hasil_bagi"][0],3 ) }} * {{$d["d_hasil_bagi"][1]}} * {{number_format($d["d_hasil_bagi"][2],3 ) }} *
                ...
                <ul>
                    = {{number_format($e["e_hasil_bagi"][0],3 ) }} * {{$e["e_hasil_bagi"][1]}} * {{$e["e_hasil_bagi"][2]}} *
                    {{$e["e_hasil_bagi"][3]}} * {{$e["e_hasil_bagi"][4]}} * {{number_format($e["e_hasil_bagi"][5],3 ) }} *
                    {{$e["e_hasil_bagi"][6]}}
                </ul>
                <ul>
                    = {{$e["e_hasil_kali"]}}
